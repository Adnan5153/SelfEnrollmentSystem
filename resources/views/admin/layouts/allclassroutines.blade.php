    ...
    <div class="row mt-5">
        <div class="col-12">
            <div class="card border-0 shadow-lg rounded-4">
                <div
                    class="card-header bg-dark bg-gradient text-white rounded-top-4 d-flex align-items-center justify-content-between">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0 table-hover">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-1">
                                                ...
                                                <form action="{{ route('classroutines.destroy', $routine->id) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center text-black-50">No class routines available.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
