...
@section('content')
    ...
    <div class="bg-white bg-opacity-75 my-5 p-5 rounded-4 shadow-lg border-0 mx-auto" style="max-width:900px;">
        ...
        <form action="{{ route('grades.store') }}" method="POST" autocomplete="off">
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control form-control-lg shadow-sm rounded-3" id="min_marks"
                                name="min_marks" min="0" required>
                        </div>
                    </div>
                    <!-- Maximum Marks -->
                    <div class="col-12 col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control form-control-lg shadow-sm rounded-3" id="max_marks"
                                name="max_marks" min="0" required>
                        </div>
                    </div>
                    <!-- Grade -->
                    <div class="col-12 col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-lg shadow-sm rounded-3" id="grade"
                                name="grade" maxlength="2" required>
                        </div>
                    </div>
                    <!-- Remarks -->
                    <div class="col-12 col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-lg shadow-sm rounded-3" id="remarks"
                                name="remarks">
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-center justify-content-md-end gap-2 mt-4">
                <button type="submit"
